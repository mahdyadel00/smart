...
@section('page_url')
    ...
    <li class="active"><a href="{{url('/adminpanel/membership/'.$membership->id.'/edit')}}">{{_i('Add')}}</a></li>
@endsection
...
@section('content')
    ...
    <div class="page-body">
        ...
        {!! Form::model($membership,['method'=>'put','url'=>['/adminpanel/membership/update',$membership->id],'class'=>'form-horizontal']) !!}
        ...
        <div class="box-body">
            ...
            <div class="form-group row {{ $errors->has('title') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-6">
                    {{Form::text('title',$membership->title,['class'=>'form-control'])}}
                    @if ($errors->has('title'))
            ...
            <div class="form-group row {{ $errors->has('is_active') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-6">
                    {{Form::select('is_active',['0'=>'not active','1'=>'active'],$membership->is_active,['class'=>'form-control'])}}
            ...
            <div class="form-group row {{ $errors->has('price') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-6">
                    {{Form::number('price',$membership->price,['class'=>'form-control'])}}
                    @if ($errors->has('price'))
                        <span class="text-danger invalid-feedback" role="alert">
            ...
            <div class="form-group row {{ $errors->has('duration') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-6">
                    {{Form::number('duration',$membership->duration,['class'=>'form-control'])}}
