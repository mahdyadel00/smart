...
@section('content')
    ...
    <div class="page-body">
        ...
        <form method="POST" action="{{ url('/adminpanel/membership/user_membership/store') }}" class="form-horizontal"  data-parsley-validate="">
            @csrf
            ...
            <div class="box-body">
                ...
                <div class="form-group row {{ $errors->has('user_id') ? ' has-error' : '' }}">
                    <label for="user_id" class="col-sm-4 control-label">{{ _i('User') }}</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group row {{ $errors->has('membership_id') ? ' has-error' : '' }}">
                    <label for="membership_1" class="col-sm-4 control-label">{{ _i('Membership') }}</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    <label for="cost" class="col-sm-4 control-label">{{_i('Price')}} :</label>
                    <div class="col-sm-6">
                        <label id='price_1' name="price" class="col-sm-4 control-label text-green" >0</label>
                        @if($errors->has('price'))
                ...
                <!----------------------------------  duration ---------------------------------- -->
                <div class="form-group row">
                    <label for="cost" class="col-sm-4 control-label">{{_i('Duration')}} :</label>
                    <div class="col-sm-6">
                        <label id='duration_1' name="duration" class="col-sm-4 control-label text-green" >0</label>
                        @if($errors->has('price'))
                ...
                <div class="form-group row {{ $errors->has('created') ? ' has-error' : '' }}">
                    <label for="created" class="col-sm-4 control-label">{{_i('Start Date')}}</label>
                    <div class="col-sm-6">
                        <input  id="created"  type="date" name="created"  class="form-control" data-inputmask="'alias': 'mm/dd/yyyy'"
                                data-mask="" value="{{old('created')}}" required="">
