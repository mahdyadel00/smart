...
@section('page_url')
    ...
    <li class="active"><a href="{{url('/adminpanel/membership/membership_perms/create')}}">{{_i('Add')}}</a></li>
@endsection
...
@section('content')
    ...
    <div class="page-header">
        <div class="page-header-title">
            <h4>{{_i('Add Membership permissions')}}</h4>
        </div>
        <div class="page-header-breadcrumb">
            <ul class="breadcrumb-title">
                ...
                <li class="breadcrumb-item"><a href="#!">{{_i('Add Membership permissions')}}</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="page-body">
        ...
        <div class="box-body">
            ...
            <form  action="{{url('/adminpanel/membership/membership_perms/store')}}" method="post" class="form-horizontal"  id="demo-form" data-parsley-validate="">
            ...
            <!----------------------------------  price  --------------------------------------------->
                <div class="form-group row {{ $errors->has('price') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-6">
                        <input id="price" type="number" name="price" value="{{old('price')}}" required="" class="form-control"
            ...
            <div class="form-group row {{ $errors->has('duration') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-6">
                    <input id="duration"  name="duration" value="{{old('duration')}}" required="" class="form-control"
            ...
            <!----------------------------------  is_active  --------------------------------------------->
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input class="form-check-input"  type="radio"  name="is_active" id="optionsRadios1" value="0" checked >
                        <label  class="form-check-label control-label" for="optionsRadios1"  > {{_i("Not Active")}} </label>
                        <input class="form-check-input"  type="radio"  name="is_active" id="optionsRadios2" value="1">
                            ...
                            <div class="checkbox checkbox-custom">
                                ...
                                <label for="{{$permission->id}}">
                                    <input class="control-label" id="{{$permission->id}}" type="checkbox" name="groups[]" value="{{$permission->id}}"
                                           {{old('perm_id') == $permission->id ? 'checked' : ''}} data-parsley-multiple="groups" required="" style="margin-right: -15px;">
                                    {{$permission->title}}
                                </label>
                            </div>
                        </div>
