@extends('admin.layout.index', [
    'title' => _i('Add Goals Modules'),
    'subtitle' => _i('Add Goals Modules'),
    'activePageName' => _i('Add Goals Modules'),
    'activePageUrl' => '',
    ...
    <div class="page-body">
        ...
        <div class="card blog-page" id="blog">
            <div class="card-block">
                ...
                <form method='post' action="{{ route('goals_modules.store') }}" class='form-group' data-parsley-validate enctype="multipart/form-data">
                    @csrf
                    <!-- ---------------------------------------------** Language ** -------------------------------------------------------------- -->
