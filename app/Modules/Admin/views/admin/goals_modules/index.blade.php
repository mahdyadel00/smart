...
'title' => _i('All Goals Modules'),
'activePageName' => _i('All Goals Modules'),
'activePageUrl' => '',
'additionalPageUrl' => route('goals_modules.create') ,
...
@section('content')
    ...
    <div class="box-body">
        <div class="row">
            @can('Create_goals_modules')
            <div class="col-sm-12 mb-3">
                <span class="pull-left">
                    <a href="{{ route('goals_modules.create') }}" class="btn btn-primary create add-permissiont"
                        type="button"><span><i class="ti-plus"></i> {{ _i('create new Goals Modules ') }} </span></a>
                </span>
            </div>
            @endcan
            <div class="col-sm-12">
