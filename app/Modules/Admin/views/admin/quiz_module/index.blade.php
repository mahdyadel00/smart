...
'activePageUrl' => '',
'additionalPageUrl' => route('quiz_module.create') ,
...
@section('content')
    ...
    <div class="box-body">
        <div class="row">
            @can('Create_quiz_module')
            <div class="col-sm-12 mb-3">
                <span class="pull-left">
                    <a href="{{ route('quiz_module.create') }}" class="btn btn-primary create add-permissiont"
                        type="button"><span><i class="ti-plus"></i> {{ _i('create new QuizModule ') }} </span></a>
                </span>
            </div>
            @endcan
            <div class="col-sm-12">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('quiz_module.store.translation') }}" method="post" class="form-horizontal"
...
@push('js')
    <script>
        ...
        $('body').on('click', '.lang_ex', function(e) {
            ...
            $.ajax({
                url: "{{ route('quiz_module.get.translation') }}",
                method: "get",
                "_token": "{{ csrf_token() }}",
                data: {
                    'lang_id': lang_id,
