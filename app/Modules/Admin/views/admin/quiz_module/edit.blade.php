    ...
    <div class="page-header">
        ...
        <div class="page-header-breadcrumb">
            <ul class="breadcrumb-title">
                ...
                <li class="breadcrumb-item"><a href="{{ route('quiz_module.index') }}">{{ _i('QuizModule') }}</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="page-body">
        ...
        <div class="card blog-page" id="blog">
            <div class="card-block">
                ...
                <form method='post' action="{{ route('quiz_module.update', $quiz_module->id) }}" class='form-group' data-parsley-validate>
                    @csrf
                    @method('POST')
                    ...
                    <!-- ---------------------------------------------** Title ** -------------------------------------------------------------- -->
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-11">
                            <input type="text" name="title" class='form-control' value='{{ $quiz_module_data->title }}'>
                            @if ($errors->has('title'))
                    ...
                    <!-- ---------------------------------------------** Description ** -------------------------------------------------------------- -->
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-11">
                            <textarea type="text" name="description" class='form-control'>{{ $quiz_module_data->description }}</textarea>
                            @if ($errors->has('title'))
                                <span class="text-danger invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('title') }}</strong>
                                </span>
                        ...
                        <div class="checkbox-fade fade-in-primary col-sm-6">
                            <label>
                                <input type="checkbox" id="checkbox" name="published" value="1"
                                    {{ $quiz_module->published == 1 ? 'checked' : '' }}>
                                <span class="cr">
                        ...
                        <div class="checkbox-fade fade-in-primary col-sm-6">
                            <label>
                                <input type="checkbox" id="checkbox" name="answer" value="1"
                                    {{ $quiz_module_data->answer == 1 ? 'checked' : '' }}>
                                <span class="cr">
                                    <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                                </span>
                            </label>
