...
'title' => _i('All Modules'),
'activePageName' => _i('All Modules'),
'activePageUrl' => '',
'additionalPageUrl' => route('modules.create') ,
        ...
        <div class="row">
            ...
            <div class="col-sm-12 mb-3">
                <span class="pull-left">
                    <a href="{{ route('modules.create') }}" class="btn btn-primary create add-permissiont"
                        type="button"><span><i class="ti-plus"></i> {{ _i('create new Modules ') }} </span></a>
                </span>
            </div>
            @endcan
            <div class="col-sm-12">
