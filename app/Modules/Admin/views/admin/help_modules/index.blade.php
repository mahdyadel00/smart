...
'title' => _i('All Help Modules'),
'activePageName' => _i('All Help Modules'),
'activePageUrl' => '',
'additionalPageUrl' => route('help_module.create') ,
...
@section('content')
    ...
    <div class="box-body">
        <div class="row">
            @can('Create_help_module')
            <div class="col-sm-12 mb-3">
                <span class="pull-left">
                    <a href="{{ route('help_module.create') }}" class="btn btn-primary create add-permissiont"
                        type="button"><span><i class="ti-plus"></i> {{ _i('create new Help Modules ') }} </span></a>
                </span>
            </div>
            @endcan
            <div class="col-sm-12">
