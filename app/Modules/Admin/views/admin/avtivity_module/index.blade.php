...
'title' => _i('All ActivityModule'),
'activePageName' => _i('All ActivityModule'),
'activePageUrl' => '',
'additionalPageUrl' => route('activity_modules.create') ,
    ...
    <script>
        $(function() {
            $('#dataTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('activity_modules.index') }}',
                columns: [{
                        data: 'title',
                        name: 'title'
                    },
