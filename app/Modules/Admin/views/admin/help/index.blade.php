...
'title' => _i('All Help'),
'activePageName' => _i('All Help'),
'activePageUrl' => '',
'additionalPageUrl' => route('help.create') ,
        ...
        <div class="row">
            ...
            <div class="col-sm-12 mb-3">
                <span class="pull-left">
                    <a href="{{ route('help.create') }}" class="btn btn-primary create add-permissiont"
                        type="button"><span><i class="ti-plus"></i> {{ _i('create new Help ') }} </span></a>
                </span>
            </div>
            @endcan
            <div class="col-sm-12">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('help.store.translation') }}" method="post" class="form-horizontal"
...
@push('js')
    <script>
        ...
        $('body').on('click', '.lang_ex', function(e) {
            ...
            $.ajax({
                url: "{{ route('help.get.translation') }}",
                method: "get",
                "_token": "{{ csrf_token() }}",
                data: {
                    'lang_id': lang_id,
