...
'title' => _i('All ContentModule'),
'activePageName' => _i('All ContentModule'),
'activePageUrl' => '',
'additionalPageUrl' => route('content_modules.create') ,
        ...
        <div class="row">
            ...
            <div class="col-sm-12 mb-3">
                <span class="pull-left">
                    <a href="{{ route('content_modules.create') }}" class="btn btn-primary create add-permissiont"
                    ...
                    <div class="card-block">
                        <div class="dt-responsive table-responsive text-center">
                            <table id="dataTable" class="table table-bordered table-striped dataTable text-center">
                                <thead>
                                    <tr role="row">
                                        <th class="sorting"> {{ _i('Goal') }}</th>
                                        <th class="sorting"> {{ _i('Video') }}</th>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('activity_modules.store.translation') }}" method="post" class="form-horizontal"
    ...
    <script>
        $(function() {
            $('#dataTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('content_modules.index') }}',
                columns: [{
                        data: 'goal',
                        name: 'goal'
                    },
        ...
        $('body').on('click', '.lang_ex', function(e) {
            ...
            $.ajax({
                url: "{{ route('activity_modules.get.translation') }}",
                method: "get",
                "_token": "{{ csrf_token() }}",
                data: {
                    'lang_id': lang_id,
