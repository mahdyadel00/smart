@extends('site.admin.layout.app',[
	'title' => _i('Create new admin'),
	'level1' => _i('Admins'),
	'level1_url' => route('site.admin.admins'),
	'level2' => _i('Create new admin'),
		...
		<div class="col-sm-12">
			...
			<div class="card">
				...
				<div class="card-block">
					<form method="POST" action="{{ route('site.admin.admins.store') }}" class="form-horizontal"  id="demo-form" data-parsley-validate="" enctype="multipart/form-data">
						@csrf
						<div class="card-body card-block">
							...
							<div class="form-group row">
								<label for="email" class="col-sm-2 control-label">{{ _i('Email') }}</label>
								<div class="col-sm-6">
							...
							<div class="form-group row">
								...
								<div class="col-sm-6">
									<input type="file" name="image" id="image" onchange="showBannerImage(this)" class="form-control" accept="image/gif, image/jpeg, image/png" value="{{old('image')}}" required="">
							...
							<div class="form-group row">
								<label for="password" class="col-sm-2 control-label">{{ _i('Role') }}</label>
								<div class="col-sm-6">
