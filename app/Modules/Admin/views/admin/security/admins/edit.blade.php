@extends('site.admin.layout.app',[
	...
	'level2' => _i('Edit admin'),
	'level2_url' => url('site.admin.admins'),
])
...
<div class="modal fade" id="default-Modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="{{ route('site.admin.admins.change_password', $user->id) }}" class="form-horizontal"  data-parsley-validate="">
                @csrf
                @method('PATCH')
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    <form method="post" action="{{ route('site.admin.admins.update', $user->id) }}" class="form-horizontal"   data-parsley-validate="">
                        @csrf
                        @method('PATCH')
                        <div class="form-group row">
