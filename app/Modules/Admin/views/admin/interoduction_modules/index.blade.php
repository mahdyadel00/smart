...
'title' => _i('All Interoduction Modules'),
'activePageName' => _i('All Interoduction Modules'),
'activePageUrl' => '',
'additionalPageUrl' => route('interoduction_modules.create') ,
...
@section('content')
    ...
    <div class="box-body">
        <div class="row">
            @can('Create_interoduction_modules')
            <div class="col-sm-12 mb-3">
                <span class="pull-left">
                    <a href="{{ route('interoduction_modules.create') }}" class="btn btn-primary create add-permissiont"
                        type="button"><span><i class="ti-plus"></i> {{ _i('create new Interoduction Modules ') }} </span></a>
                </span>
            </div>
            @endcan
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>{{ _i('All Interoduction Modules') }}</h5>
                            ...
                            <table id="dataTable" class="table table-bordered table-striped dataTable text-center">
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting"> {{ _i('Image Module') }}</th>
    ...
    <script>
        $(function() {
            $('#dataTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('interoduction_modules.index') }}",
                columns: [{
                        data: 'title',
                        name: 'title'
                    },
