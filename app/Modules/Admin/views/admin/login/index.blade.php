...
[
	'title' => _i('Login'),
	'subtitle' => _i('Login'),
	'activePageName' => _i('Login'),
	'activePageUrl' => route('login.index'),
	'additionalPageName' =>  _i('Login'),
	'additionalPageUrl' => route('login.index')
])
@section('content')
<div class="box-body">
	<div class="row">
		...
		<div class="col-sm-12 mb-3">
			...
			<button class="btn btn-primary create add-permissiont" type="button" data-toggle="modal"
				...
				<span><i class="ti-plus"></i> {{_i('Create new Login')}} </span>
			</button>
			</span>
		</div>
        @endcan
...
<script>
    ...
    //    alert(transRowId);
		$.ajax({
			url: '{{route('login.get.translation')}}',
			method: "get",
			"_token": "{{ csrf_token() }}",
			data: {
				'lang_id': lang_id,
