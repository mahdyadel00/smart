...
'title' => _i('Edit Insturcation'),
'subtitle' => _i('Edit Insturcation'),
'activePageName' => _i('Edit Insturcation'),
'activePageUrl' => '',
    ...
    <div class="page-header">
        ...
        <div class="page-header-breadcrumb">
            <ul class="breadcrumb-title">
                ...
                <li class="breadcrumb-item"><a href="{{ route('insturctions.index') }}">{{ _i('Insturcation') }}</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="page-body">
        ...
        <div class="card blog-page" id="blog">
            <div class="card-block">
                ...
                <form method='post' action="{{ route('insturctions.update', $insturction->id) }}" class='form-group' data-parsley-validate enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    ...
                    <!-- ---------------------------------------------** Title ** -------------------------------------------------------------- -->
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-11">
                            <input type="text" name="title" class='form-control' value='{{ $insturction->data->title }}'>
                            @if ($errors->has('title'))
