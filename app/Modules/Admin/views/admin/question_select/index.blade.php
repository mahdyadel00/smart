...
'title' => _i('All Questions Select'),
'activePageName' => _i('All Questions Select'),
'activePageUrl' => '',
'additionalPageUrl' => route('question_select.create') ,
...
@section('content')
    ...
    <div class="box-body">
        <div class="row">
            @can('Create_question_select')
            <div class="col-sm-12 mb-3">
                <span class="pull-left">
                    <a href="{{ route('question_select.create') }}" class="btn btn-primary create add-permissiont"
                        type="button"><span><i class="ti-plus"></i> {{ _i('create new Questions Select ') }} </span></a>
                </span>
            </div>
            @endcan
            <div class="col-sm-12">
    ...
    <script>
        $(function() {
            $('#dataTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('question_select.index') }}',
                columns: [{
                        data: 'title',
                        name: 'title'
                    },
