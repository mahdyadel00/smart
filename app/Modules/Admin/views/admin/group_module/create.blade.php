...
'title' => _i('All Group Module'),
'activePageName' => _i('All Group Module'),
'activePageUrl' => '',
    ...
    <div class="page-body">
        ...
        <div class="card blog-page" id="blog">
            <div class="card-block">
                ...
                <form method='post' action="{{ route('group_module.store') }}" class='form-group' data-parsley-validate enctype="multipart/form-data">
                    @csrf
