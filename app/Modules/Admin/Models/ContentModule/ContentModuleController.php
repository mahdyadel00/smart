...
class ContentModuleController extends Controller
{
    ...
    protected function index()
    {
        ...
        return view('admin.content_module.index');
    }//End of Index
    ...
    protected function create()
    {
        ...
        return view('admin.content_module.create', compact('languages' , 'modules'));
    }// End of Create
    ...
    protected function edit($id)
    {
        ...
        return view('admin.content_module.edit', compact('content_module' , 'modules'));
    }//End of Edit
