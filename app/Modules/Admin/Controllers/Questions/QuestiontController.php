...
class QuestiontController extends Controller
{
    ...
    protected function store(Request $request)
    {
        ...
        if ($request->has('option1') || $request->has('option2') || $request->has('option3') || $request->has('option4') != null) {

            $question_option = QuestionSelect::create([
        ...
        return redirect()->route('questions.index')->with('flash_message', _i('Added Successfully !'));
    }
